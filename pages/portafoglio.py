...
# Protezione prima di risolvere qualunque path utente. Se la sessione Streamlit
# viene persa/sospesa dal browser mobile, require_login deve fermare la pagina e
# riportare al login invece di far esplodere get_user_portfolio_path().
require_login()
