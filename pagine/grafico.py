...
if len(df_chart) >= 200:
    ...
    # NUOVA LINEA: Quotazione corrente tratteggiata sottile ad alta visibilità
    ...
    # Layout finale pulito Stile Dark (Margini ottimizzati a destra a r=160 per non tagliare i prezzi)
    fig.update_layout(
